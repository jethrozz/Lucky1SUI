      ...
      <div className="bg-gradient-to-br from-primary to-primary-light text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg max-w-2xl">
            Get answers to common questions about CapyLotto, our lossless lottery on the Sui blockchain.
          </p>
        </div>
      </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-neutral-dark">
                  ...
                  With CapyLotto, your deposited SUI tokens remain yours and can be withdrawn at any time. 
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-lg font-medium text-primary">
                  How does CapyLotto work?
                </AccordionTrigger>
                <AccordionContent className="text-neutral-dark">
                  CapyLotto works in three simple steps:
          ...
          <Card className="p-6 mb-8">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-neutral-dark">
                  The minimum entry amount is 10 SUI. Each 100 SUI you deposit gives you one lottery ticket. For example, a 250 SUI deposit would give you 2 tickets, with 50 SUI contributing toward a third ticket but not enough to complete it.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-neutral-dark">
                  CapyLotto holds weekly draws. The exact time and date of the next draw is always displayed on the home page. All draws are conducted automatically by our smart contract, with no human intervention.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-neutral-dark">
                  Yes, you can withdraw your deposit at any time. However, if you withdraw before the draw, your tickets will no longer be valid for that draw. Your withdrawn funds will be returned to your wallet in full (minus network transaction fees).
                </AccordionContent>
              </AccordionItem>
          ...
          <Card className="p-6 mb-8">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-neutral-dark">
                  If your ticket is selected as the winner, the prize will be automatically transferred to your connected wallet address. You don't need to claim it manually. You'll receive a notification, and the transaction can be verified on the Sui blockchain explorer.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-neutral-dark">
                  Tax regulations vary by country and jurisdiction. CapyLotto cannot provide tax advice, and we recommend consulting with a tax professional regarding any potential tax obligations on your lottery winnings.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </Card>
          ...
          <Card className="p-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-neutral-dark">
                  CapyLotto currently supports Sui Wallet, Ethos Wallet, and other wallets compatible with the Sui blockchain. We're continuously working to add support for more wallets.
                </AccordionContent>
              </AccordionItem>
