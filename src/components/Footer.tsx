        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-my-color hover:text-secondary-light transition">GitHub Repository</a></li>
              <li><a href="#" className="text-my-color hover:text-secondary-light transition">Sui Developer Docs</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-my-color hover:text-my-color transition flex items-center">
